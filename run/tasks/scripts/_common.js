...
module.exports = {
     ...
     */
    bundles: [
        // The progressive-enhancement bootstrapper, which asynchronously loads in the
        // full styles after the page is already interactive. This bundle's output is
        // inlined at the end of the page.
        { srcPath: './src/', fileName: 'base', excludes: [] },
